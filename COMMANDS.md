...
The 38 numbered competency tests in [competency_tests/](competency_tests/) are a
separate exercise with their own fixtures, project-local checks and generated
report.

```powershell
uv run python competency_tests/run_competency_checks.py   # runs all 38, regenerates both documents
